...
// Labels de categorías para los selectores
...
<head>
    ...
    <style>
        ...
        .grupo-plantilla-info i.fa-folder-open {
            font-size: 48px;
            color: #3498db;
            margin-bottom: 15px;
            display: block;
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="grupo-header" id="grupoHeader">
                <div class="grupo-icon-large" id="CategoriaIcon">📁</div>
                <div class="grupo-info">
                    <h2 id="CategoriaNombre">Cargando...</h2>
                    <p id="CategoriaDescripcion"></p>
                    <small class="grupo-padre-link"><i class="fas fa-folder"></i> Grupo: <a href="#" id="linkConfigGrupo"><span id="GrupoPadreNombre">-</span></a></small>
                </div>
            </div>
            ...
            <form id="configForm">
                ...
                <div id="grupoPlantillaInfo" class="grupo-plantilla-info" style="display: block;">
                    <i class="fas fa-folder-open"></i>
                    <p>Esta categoría está usando la plantilla del grupo padre.</p>
                    <p style="margin-top: 10px;">
                        <a href="#" id="linkConfigGrupo2">
    ...
    <script>
        ...
        let categoriaNombreActual = 'Nombre de Categoría'; // Se actualiza al cargar la config
        ...
        function updateRazonMarkerText() {
            ...
            if (razonTextarea && razonMarkerText && razonMarker) {
                ...
                // Reemplazar variables con valores reales para previsualización
        ...
        async function loadCategoriaConfig() {
            try {
                ...
                if (data.success) {
                    ...
                    // Guardar nombres para usarlos en variables de razón
                    categoriaNombreActual = categoria.nombre || 'Nombre de Categoría';
                    grupoNombreActual = categoria.grupo_nombre || 'Nombre del Grupo';
                    ...
                    // Actualizar links al grupo
                    const linkConfigGrupo = document.getElementById('linkConfigGrupo');
                    const linkConfigGrupo2 = document.getElementById('linkConfigGrupo2');
                    if (linkConfigGrupo && grupoId) {
                        linkConfigGrupo.href = `config_grupo.php?id=${grupoId}`;
                    }
                    if (linkConfigGrupo2 && grupoId) {
                        linkConfigGrupo2.href = `config_grupo.php?id=${grupoId}`;
                    }
                ...
                console.error('Error:', error);
                alert('Error al cargar la configuración de la categoría');
            }
        }
