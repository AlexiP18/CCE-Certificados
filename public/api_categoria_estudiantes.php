...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    switch ($action) {
        case 'listar_matriculados':
            ...
            $sql = "
                  SELECT ce.id as matricula_id, ce.estudiante_id, ce.fecha_matricula, ce.estado, ce.notas, ce.periodo_id,
                      e.id, e.nombre, e.cedula, e.celular, e.email, e.fecha_nacimiento, e.destacado,
        ...
        case 'search':
            ...
            $sql = "
                SELECT e.id, e.nombre, e.cedula, e.celular, e.email,
                ...
                foreach ($menores as $menor) {
                    ...
                    $stmt = $pdo->prepare("
                        INSERT INTO estudiantes (
                            ...
                            representante_celular, representante_email, representante_id, activo
                        ) VALUES (?, ?, ?, ?, ?, 1, ?, ?, ?, ?, ?, 1)
                    ");
                    $stmt->execute([
                        $menor['nombre'],
