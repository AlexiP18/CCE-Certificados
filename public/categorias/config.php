    ...
    <div class="container">
        <header>
            ...
            <div class="action-buttons">
                ...
                <a href="../dashboard/index.php" class="btn"><i class="fas fa-home"></i> Inicio</a>
            </div>
        </header>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="checkbox-group">
                                ...
                                <div class="checkbox-item">
                                    <input type="checkbox" id="var_destacado" value="destacado" checked>
                                    <label for="var_destacado"><i class="fas fa-star"></i> Destacado</label>
                                </div>
                            </div>
                            ...
                            <div class="canvas-container" id="canvasContainer">
                                ...
                                <div class="draggable destacado-marker" id="destacadoMarker" data-type="destacado" style="left: 50px; top: 50px;">
                                    <img id="destacadoMarkerImg" src="" alt="Destacado" style="width: 100%; height: 100%; object-fit: contain;">
                                </div>
                            </div>
                            ...
                            <div class="coordinates-info">
                                ...
                                <div class="coord-item" id="coordDestacadoContainer">
                                    <span class="coord-label"><i class="fas fa-star"></i> Destacado</span>
                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="variable-tab-content" id="tab-destacado">
                                <div class="form-group">
                                    <label for="tamanio_destacado">Tamaño (px)</label>
                                    <input type="number" id="tamanio_destacado" name="tamanio_destacado" 
                                           value="100" min="20" max="300">
                                </div>
                                <div class="form-group">
                                    <label for="destacado_tipo">Tipo de Elemento</label>
                                    <select id="destacado_tipo" name="destacado_tipo">
                                ...
                                <div class="form-group" id="destacado_icono_group">
                                    ...
                                    <div class="icon-selector">
                                        <!-- Los iconos se generarán dinámicamente o estáticos -->
                                        <label class="icon-option">
                                            <input type="radio" name="destacado_icono" value="estrella" checked>
                                            <img src="../../assets/stickers/estrella.png" onerror="this.src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCIgZmlsbD0iI2YxYzQwZiI+PHBhdGggZD0iTTEyIDE3LjI3TDE4LjE4IDIxbC0xLjY0LTcuMDNMMjIgOS4yNGwtNy4xOS0uNjFMMTIgMiA5LjE5IDguNjMgMiA5LjI0bDUuNDYgNC43M0w1LjgyIDIxeiIvPjwvc3ZnPg=='">
                                        </label>
                                        <label class="icon-option">
                                            <input type="radio" name="destacado_icono" value="medalla">
                                            <img src="../../assets/stickers/medalla.png" onerror="this.src='data:image/svg+xml;base64,'">
                                        </label>
                                        <label class="icon-option">
                                            <input type="radio" name="destacado_icono" value="trofeo">
                                            <img src="../../assets/stickers/trofeo.png" onerror="this.src='data:image/svg+xml;base64,'">
                                        </label>
                                        <label class="icon-option">
                                            <input type="radio" name="destacado_icono" value="certificado">
                                            <img src="../../assets/stickers/certificado.png" onerror="this.src='data:image/svg+xml;base64,'">
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function drag(e) {
            ...
            if (type === 'nombre' || type === 'razon' || type === 'fecha') {
                ...
                // Destacado se posiciona desde el centro
        ...
        function updateMarkerPositions() {
            ...
            // Posicionar Destacado
            if (destacadoMarker) {
                const posDestacadoX = document.getElementById('posicion_destacado_x');
                const posDestacadoY = document.getElementById('posicion_destacado_y');
                const destacadoX = parseInt(posDestacadoX?.value) || 50;
                const destacadoY = parseInt(posDestacadoY?.value) || 50;
                
                // Destacado se posiciona desde el centro
                const destWidth = destacadoMarker.offsetWidth || 100;
                const destHeight = destacadoMarker.offsetHeight || 100;
                
                let left = (destacadoX * canvasScale) - (destWidth / 2);
                let top = (destacadoY * canvasScale) - (destHeight / 2);
                
                // Asegurar que esté dentro del canvas
                left = Math.max(-10, Math.min(left, canvasWidth - destWidth + 10));
                top = Math.max(-10, Math.min(top, canvasHeight - destHeight + 10));
        ...
        function updateMarkerSizes() {
            ...
            // Aplicar tamaño escalado al marcador Destacado
            if (destacadoMarker) {
                const destSize = Math.max(20, tamanioDestacado * canvasScale);
                destacadoMarker.style.width = destSize + 'px';
                destacadoMarker.style.height = destSize + 'px';
            }
        }
        ...
        function initSizeChangeEvents() {
            ...
            if (tamanioDestacado) {
                tamanioDestacado.addEventListener('input', () => {
                    updateMarkerSizes();
                    updateMarkerPositions(); // Reposicionar pues el tamaño afecta el centro
                });
            }
        ...
        function updateMarkersVisibility() {
            ...
            const varDestacado = document.getElementById('var_destacado');
            ...
            const destacadoEnabled = varDestacado?.checked ?? true;
            ...
            if (coordDestacadoContainer) coordDestacadoContainer.style.display = destacadoEnabled ? 'block' : 'none';
        }
        ...
        // Inicializar eventos de destacado
        function initDestacadoEvents() {
            const destacadoTipo = document.getElementById('destacado_tipo');
            if (destacadoTipo) {
                destacadoTipo.addEventListener('change', toggleDestacadoOptions);
            }
        ...
        function toggleDestacadoOptions() {
            ...
            // const groupImagen = document.getElementById('destacado_imagen_group'); // Si existiera en el HTML
        ...
        function updateDestacadoMarkerImage() {
            ...
            if (tipo === 'imagen') {
                // Lógica para imagen personalizada si se implementa
                /*
            ...
            if (iconoSeleccionado && iconoSeleccionado.value) {
                ...
                // const basePathClean = (typeof basePath !== 'undefined') ? basePath : '../../';
                // Asumiendo estructura: public/assets/stickers
                const newSrc = `../../assets/stickers/${iconoSeleccionado.value}.png`;
        ...
        // Listener para tipo de destacado
        const destacadoTipoSelect = document.getElementById('destacado_tipo');
        if (destacadoTipoSelect) {
            destacadoTipoSelect.addEventListener('change', toggleDestacadoOptions);
        }
        ...
        async function loadTemplateConfig(templateId) {
            try {
                const response = await fetch(`api/categorias/plantillas.php?action=get_config&categoria_id=${categoriaId}&plantilla_id=${templateId}`);
                const data = await response.json();
        ...
        async function saveTemplateConfig() {
            ...
            try {
                ...
                const response = await fetch('../api/categorias/plantillas.php', {
                    method: 'POST',
                    body: formData
                });
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (linkConfigGrupo && grupoId) {
                        linkConfigGrupo.href = `../grupos/config.php?id=${grupoId}`;
                    }
                    ...
                    setValueIfExists('posicion_destacado_x', Categoria.plantilla_pos_destacado_x || Categoria.posicion_destacado_x || 50);
                    setValueIfExists('posicion_destacado_y', Categoria.plantilla_pos_destacado_y || Categoria.posicion_destacado_y || 50);
                    setValueIfExists('tamanio_destacado', Categoria.plantilla_tamanio_destacado || Categoria.tamanio_destacado || 100);
                    setValueIfExists('destacado_tipo', Categoria.plantilla_destacado_tipo || Categoria.destacado_tipo || 'icono');
                    
                    // Seleccionar icono destacado
                    const destacadoIcono = Categoria.plantilla_destacado_icono || Categoria.destacado_icono || 'estrella';
                    const iconoRadio = document.querySelector(`input[name="destacado_icono"][value="${destacadoIcono}"]`);
                    ...
                    if (Categoria.plantilla_variables_habilitadas || Categoria.variables_habilitadas) {
                        try {
                            const savedVars = JSON.parse(Categoria.plantilla_variables_habilitadas || Categoria.variables_habilitadas);
        ...
        document.getElementById('configForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('../api/categorias/config.php', {
                    method: 'POST',
                    body: formData
                });
